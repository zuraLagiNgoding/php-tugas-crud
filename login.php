...
<body>
    <form style="font-family: 'Inter', sans-serif;" action="controller/login.php" method="post" class="w-full h-screen flex justify-center items-center bg-[#EEF2F5]">
        <div class="flex bg-white rounded-2xl p-16 min-w-[50rem] h-[30rem] items-center">
            <div class="basis-2/4">
                <img src="asset/Woman.png" alt="woman" class="w-56">
            </div>
            <div class="basis-2/4 flex flex-col gap-4 justify-center">
                ...
                <div class="flex flex-col gap-4 text-center mt-4">
                    ...
                    <p class="text-sm">haven't created an account? <a href="register.php" class="text-blue-500 ">register now</a></p>
                </div>
            </div>
        </div>
    </form>
