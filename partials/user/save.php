<form method="POST" action="controller/save_user.php" class="shadow-xl flex flex-col justify-between bg-white rounded-2xl p-8 h-full">
    <div class="flex flex-col gap-4">
        ...
        <div class="flex gap-12">
            <div class="basis-1/2 flex items-center gap-4">
                ...
                <input type="text" name="username" class="basis-4/5 border border-slate-500 py-1 px-2 !outline-none rounded-lg">
            </div>
            <div class="basis-1/2 flex items-center gap-4">
                <label for="email" class="basis-1/5 font-semibold">Email</label>
                <input type="text" name="email" class="basis-4/5 border border-slate-500 py-1 px-2 !outline-none rounded-lg">
            </div>          
        </div>
        <div class="flex gap-12">
            <div class="basis-1/2 flex items-center gap-4">
                <label for="password" class="basis-1/5 font-semibold">Password</label>
                <input type="text" name="password" class="basis-4/5 border border-slate-500 py-1 px-2 !outline-none rounded-lg">
            </div>
            <div class="basis-1/2 flex items-center gap-4">
            </div>
        </div>
