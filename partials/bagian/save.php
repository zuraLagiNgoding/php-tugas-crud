<form method="POST" action="controller/save_bagian.php" class="shadow-xl flex flex-col justify-between bg-white rounded-2xl p-8 h-full">
    <div class="flex flex-col gap-4">
        ...
        <div class="flex gap-12">
            <div class="basis-1/2 flex items-center gap-4">
                ...
                <input type="text" name="id_bagian" class="basis-4/5 border border-slate-500 py-1 px-2 !outline-none rounded-lg">
            </div>
            <div class="basis-1/2 flex items-center gap-4">
                <label for="nama_bagian" class="basis-1/5 font-semibold">Nama Bagian</label>
                <input type="text" name="nama_bagian" class="basis-4/5 border border-slate-500 py-1 px-2 !outline-none rounded-lg">
            </div>
        </div>
    </div>
    <div class="w-full">
